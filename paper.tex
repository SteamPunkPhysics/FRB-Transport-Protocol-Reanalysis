...
\title{\vspace{-2em}\textbf{A transport protocol in repeating fast radio bursts,\\
...
(\texttt{spectra.npy}, \texttt{tables1.dat.txt},
\texttt{frb20201124a\_parameters.csv}, \texttt{spectra\_20220912a.npy}, and three
public-domain control corpora from Project Gutenberg: \texttt{english\_sample.txt},
ebook \#2701; \texttt{math\_sample\_prose.txt}, \#58881;
\texttt{math\_sample\_puzzles.txt}, \#16713).
