...
\large A Minimal Reproducible Reanalysis of \emph{Evidence for Structured Signal
Traffic in Fast Radio Burst Data}}
...
different properties, and none of them is claimed.
...
\textbf{Every number computed for the core three-part reanalysis is printed by}
\texttt{python frb\_three\_part.py}, a single script requiring only \texttt{numpy},
...
\doi{10.57760/sciencedb.Fastro.00030} \cite{zhangjs2025}). The handful of results quoted from the
