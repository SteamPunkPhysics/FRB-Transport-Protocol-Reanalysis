...
long, as the real stream. And it follows the source, not the instrument: the
same fingerprint tracks FRB~121102 through two different telescopes, while
different sources through one telescope stay distinct. Every prediction
testable on a third source, stated in advance, was confirmed.
