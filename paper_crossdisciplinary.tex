...
FRB~20201124A, and finds the same channel architecture again at a second. Each
burst contributes one symbol, classified from the shape of its radio spectrum,
and the symbol sequence shows: a
repeating 32-symbol frame, a dominant carrier wrapping five sub-channels, a
...
identical pipeline manages 2.3, and six signal shapes learned from early
