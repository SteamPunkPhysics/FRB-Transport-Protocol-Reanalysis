...
\smallskip
\noindent
\textbf{1. The protocol.} The toolkit of protocol reverse engineering, the
discipline that recovers unknown transmission formats from captured traffic,
...
\smallskip
\noindent
\textbf{3. The language test.} The
statistical language tests of the animal-communication literature, applied to
what remains, pass on every axis, at or beyond English's own values: context
...
through models of the dispersion their signals accumulate, and the foreground
